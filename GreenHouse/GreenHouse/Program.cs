...
namespace GreenHouse
{
    static class Program
    {
        ...
        private class InitImageRepository
        {
            ...
            public void Init()
            {
                UIElement heater = new UIElement("Обогреватель", DeviceType.Device, Area.AirTemperature, @"D:\heater.jpg", 196, 165);
                UIElement water = new UIElement("Увлажнитель", DeviceType.Device, Area.WaterTemperature, @"D:\humidifier.jpg", 196, 165);
                UIElement nutrient = new UIElement("Дозатор удобрений", DeviceType.Device, Area.Nutrient, @"D:\dispenser.jpg", 196, 165);

                UIElement acidSensor = new UIElement("Датчик кислотности", DeviceType.PasssiveSensor, Area.Acid, @"D:\acidity.jpg", 196, 165);
                UIElement waterTempSensor = new UIElement("Датчик температуры воды", DeviceType.PasssiveSensor, Area.WaterTemperature, @"D:\water.jpg", 196, 165);
                UIElement nutrientSensor = new UIElement("Датчик температуры воздуха", DeviceType.PasssiveSensor, Area.AirTemperature, @"D:\air.jpg", 196, 165);
